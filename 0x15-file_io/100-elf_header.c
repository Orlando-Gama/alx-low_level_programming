 ...
 *
 * Description: If the file is hardly an ELF file - exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
 ...
 *
 * Description: If the file can hardly be closed - exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
 ...
 * Return: 0 on success.
 *
 * Description: If the file is hardly an ELF File or
